...
const GfsStoreStyle = document.createElement('template');

GfsStoreStyle.innerHTML = `<dom-module id="gfs-store-styles">
    <template>
        <style>
            :host {
...
document.head.appendChild(GfsStoreStyle.content);